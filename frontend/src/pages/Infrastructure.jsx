...
const networkInlineImages = [
  ...
  },
  {
    ...
    caption: "Switching infrastructure supporting access and distribution layers.",
  },
];
...
const helpdeskOperationsSections = [
  {
    title: "Overview",
    body:
      "The Campus Network Helpdesk serves as the primary technical support and operations unit responsible for ensuring uninterrupted network connectivity across the academic, residential, and hostel areas of the campus.",
  },
  {
    title: "Scope of Network Infrastructure",
    body:
      "The team manages and supports a diverse, large-scale network infrastructure comprising Layer 1, Layer 2, and Layer 3 architectures, delivering reliable wired, wireless, and GPON-based connectivity to students, faculty, staff, laboratories, offices, classrooms, guest houses, and residential complexes.",
  },
  {
    title: "Continuous Monitoring and Coordination",
    body:
      "The team continuously monitors network health, bandwidth utilization, device status, and service availability while coordinating with multiple stakeholders during planned maintenance activities, infrastructure upgrades, and new deployments.",
  },
  {
    title: "Support for Institute Events",
    body:
      "Support is also extended to institute events, conferences, workshops, seminars, and visiting delegates by establishing temporary or permanent network connectivity tailored to operational requirements.",
  },
];
...
const smartRackImages = {
  rackRow: [
    ...
    },
    {
      ...
      caption: "Integrated rack containment supporting separated hot and cold aisles.",
    },
  ],
  ups: [
    {
...
const smartRackFacilitySections = [
  {
    ...
    body:
      "The department hosts six high-performance PC laboratories engineered for student and research workloads. Each laboratory is equipped with a dedicated Central Air Conditioning system for continuous climate control, along with an independent UPS system so a localized power disruption in one lab has no effect on the others.",
  },
  {
    title: "Computer & Informatics Centre Server Room",
    body:
      "The main CIC Server Room houses core operational servers and enterprise hardware, protected by specialized online UPS systems and a combined cooling matrix using Central AC, Cassette AC, and Tower AC units to eliminate hotspot risks across uneven heat loads.",
  },
  {
    title: "Dedicated Cloud & NDL Server Room",
    body:
      "A specialized isolated server room houses the National Digital Library hardware together with the Institute's Private Cloud infrastructure. This zone operates on an independent UPS system and a dedicated standalone 12TR Air Conditioning system tailored for high-density server heat dissipation.",
  },
  {
    title: "Central Network Facility",
    body:
      "The Central Network Room anchors the campus backbone with core routing equipment, security appliances, and GPON OLT devices. Redundant online UPS systems and an independent 21TR Air Conditioning system maintain campus-wide connectivity and continuous telecommunication routing.",
  },
];
...
const infrastructureSections = [
  ...
  },
  {
    id: "server-storage",
    name: "Server & Storage",
    description: "Server and storage infrastructure details will be added here.",
    icon: Server,
      ...
      <section className="py-16">
        <div className="mx-auto grid max-w-[1640px] gap-10 px-4 sm:px-6 2xl:px-10 xl:grid-cols-[0.78fr_1.22fr]">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-black leading-tight text-slate-950 md:text-4xl">
              Connectivity support across academic, hostel, and residential areas
            </h2>
          </div>
                  ...
                  {networkBannerImages.map((image, index) => (
                    <span
                      ...
                      className={`h-1.5 w-6 rounded-full transition ${
                        index === networkBannerIndex ? "bg-cicBlue" : "bg-slate-300"
                      }`}
                    />
                  ))}
                </div>
